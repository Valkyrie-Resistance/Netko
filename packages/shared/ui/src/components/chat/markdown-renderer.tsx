    ...
    <div className="space-y-3">
      <Markdown 
        ...
        components={{
          ...
          blockquote: ({ node, ...props }) => <blockquote {...props} className="border-l-4 border-gray-300 pl-4 italic" />,
          code: ({ node, ...props }) => <code {...props} className="rounded bg-gray-100 px-1 py-0.5 text-sm dark:bg-gray-800" />,
          pre: ({ node, ...props }) => <pre {...props} className="overflow-auto rounded-lg bg-gray-100 p-4 dark:bg-gray-800" />,
          hr: ({ node, ...props }) => <hr {...props} className="my-4 border-gray-200" />,
          table: ({ node, ...props }) => <table {...props} className="w-full border-collapse" />,
          th: ({ node, ...props }) => <th {...props} className="border border-gray-300 px-4 py-2" />,
